...
{  
   ...
   //设置该引脚为复用输出功能,输出TIM3 CH1和TIM3 CH2的PWM脉冲波形	(GPIOA.6 | GPIOA.7)
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7; //TIM_CH1和TIM_CH2
   ...
   //初始化TIM3
	...
	TIM_OCInitStructure. TIM_Pulse=(arr+1)/2-1;//初始的CCR值，使舵机在中间
