...
def direction_1():             #Do the reciprocating motion in both directions
    X=675
    Y=0
    P=0
    Q=0
...
def direction_2():           #Do the reciprocating motion in both directions
    X=675
    Y=1
    P=0
    Q=0
...
def run_derection_in_sequence(func1, func2, iterations):          #The direction changes every 10 frames, the opposite of before
    for _ in range(iterations):
        results.extend([func1() for _ in range(10)])
        results.extend([func2() for _ in range(10)])
...
#The edge of the arena      
    ...
    if dist>dis_safe:                                            #In order to make it easier for the mice to notice the artificial prey, the artificial prey moved slowly and reciprocated at a warning distance
        
        run_functions_in_sequence(derection_1, derection_2, 100000000000)
